...
'</div>'+
'</div>')}
const hasTemp=localStorage.getItem('skin-color');if(!!hasTemp){$('head').append('<link id="tempSkin" rel="stylesheet" href="/css/style-'+hasTemp+'.css">')
